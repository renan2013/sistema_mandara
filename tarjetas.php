...
<body>
    ...
    <select class="form-control" id="exampleFormControlSelect1" name="nombreImagen">
      <option value="tratamiento_facial.png">Limpieza Facial</option>
      <option value="dermapen.png">Dermapén + Limpieza Facial</option>
      <option value="tratamiento_reafirmante.png">Reafirmante Facial</option>
      <option value="ondulado.png">Ondulado de Pestañas</option>
      <option value="micro_ojos.png">Micropigmentación de Ojos</option>
      <option value="micropigmentacion_labios.png">Micropigmentación de Labios</option>
      <option value="micropigmentacion_cejas.png">Microblanding de Cejas</option>
      <option value="masaje.png">Masaje Relajante</option>
